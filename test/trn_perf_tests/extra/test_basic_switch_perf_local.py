...
class test_basic_switch_perf(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.droplets = {
            "d2": droplet("d2", droplet_type="linux", control_ip='10.0.0.104', benchmark=True, phy_itf='enp2s0f0'),
            "d3": droplet("d3", droplet_type="linux", control_ip='10.0.0.180', benchmark=True, phy_itf='enp2s0f0'),
        }
    ...
    def test_basic_switch_perf(self):
        ...
        do_iperf_common_tests(self, self.ep0, self.ep1)
